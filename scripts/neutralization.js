...
function setup() {
  createCanvas(800, 500);
    ...
    buttons.NH4= new Buttons(515, 310, 37, 196, 245,"NH₄")
...
function handleButtons(){
  ...
  if (buttons.BaOH2.isPressed() && !buttons.BaOH2.pressed && mixture.bases.length < 10) {
    ...
    mixture.bases.push(new Spheres(x + 25, y, OH[0], OH[1], OH[2], "OH⁻"))
    mixture.bases.push(new Spheres(x + 15, y, OH[0], OH[1], OH[2], "OH⁻"))
...
function updateWater(){
  for (let i = 0; i < mixture.water.length; i++) {
    ...
    if (mixture.water[i].transparency <= 0) {  // Remove fully transparent bases
      console.log('rawr')
